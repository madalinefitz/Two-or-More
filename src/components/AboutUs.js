...
function AboutUs(){
    return(
        <div className="bg-[#FDFDFD] p-10 bg-cover h-auto">
            ...
            <div className="flex justify-between m-10 mt-8">
                <div className="text-[#292929] bg-[#E8E4DE] shadow-lg content-center w-2/3 m-10 p-10">
                    <h1 className="font-bold pb-3 text-5xl text-center">MEET KARIS</h1>
                    <img src={karisProfile} alt="Whitney" className="rounded-full  w-52 h-52 float-left mt-16"/>
