    ...
    return(
        <div className="bg-[#D6C6AA] p-10 bg-cover h-auto">
            <div className="flex justify-between m-3 mt-8">
                <span className="text-[#292929] bg-[#E8E4DE] shadow-lg content-center w-2/3 text-center text-2xl p-16 m-2">
                ...
                <span className="text-[#D6C6AA] bg-[#292929] shadow-lg content-center w-1/3 text-center text-xl m-2 p-10">
            ...
            <div className="flex justify-between bg-[#292929] p-5 shadow-lg">
                <div className="m-10 items-center content-center">
                    <h1 className="text-[#D6C6AA] text-5xl text-center pb-10 [word-spacing:20px] font-semibold">MEET BRIAN</h1>
